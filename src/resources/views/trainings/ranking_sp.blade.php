  ...
  <div class="mx-auto min-h-screen w-full max-w-[430px] overflow-x-hidden bg-[#F8FAFF] px-3 pb-28 pt-4">
      ...
      <section class="mb-5 overflow-hidden rounded-[18px] bg-gradient-to-br from-[#1D66F3] to-[#0648D8] text-white shadow-[0_14px_28px_rgba(13,79,232,0.28)]">
          <div class="relative min-h-[156px] px-5 pb-5 pt-5">
              <div class="relative z-10 flex items-center gap-3">
                  ...
                  <h1 class="text-[28px] font-black leading-tight tracking-[0.01em]">
                      トレーニングランキング
                  </h1>
              </div>

              <p class="relative z-10 mt-4 text-[18px] font-bold leading-relaxed text-blue-50">
                  毎日の積み重ねが見える ✨
              </p>
          ...
          <div class="grid grid-cols-3 border-t border-white/20 bg-white/8 px-2 py-4">
              <div class="flex min-w-0 items-center justify-center gap-1 border-r border-white/25 px-1">
                  <span class="shrink-0 text-[30px]">👑</span>
                  <div class="min-w-0">
                      <p class="text-[13px] font-bold leading-none text-blue-50">今月順位</p>
                      <p class="mt-2 text-[28px] font-black leading-none">
              ...
              <div class="flex min-w-0 items-center justify-center gap-1 border-r border-white/25 px-1">
                  <span class="shrink-0 text-[32px]">🪙</span>
                  <div class="min-w-0">
                      <p class="text-[13px] font-bold leading-none text-blue-50">総ポイント</p>
                      <p class="mt-2 text-[27px] font-black leading-none">
              ...
              <div class="flex min-w-0 items-center justify-center gap-1 px-1">
                  <span class="shrink-0 text-[30px]">📈</span>
                  <div class="min-w-0">
                      <p class="text-[13px] font-bold leading-none text-blue-50">あと35ptで</p>
      ...
      <div class="mb-5 grid grid-cols-2 gap-3">
          <button
              ...
              class="rounded-[12px] border border-[#0D4FE8] bg-[#0D4FE8] px-4 py-3 text-[22px] font-black text-white shadow-[0_8px_18px_rgba(13,79,232,0.18)]">
              月間
          </button>
          ...
          <button
              ...
              class="rounded-[12px] border border-[#DDE6F5] bg-white px-4 py-3 text-[22px] font-black text-[#071433] shadow-[0_8px_18px_rgba(15,43,95,0.06)]">
              総合
          </button>
      </div>
      ...
      <section class="mt-5 overflow-hidden rounded-[18px] border border-[#DDE6F5] bg-white px-5 py-5 shadow-[0_8px_22px_rgba(15,43,95,0.06)]">
          <div class="flex items-center gap-4">
              <div class="flex h-[92px] w-[92px] shrink-0 items-center justify-center text-[72px]">
                  🪴
              </div>
              ...
              <div class="min-w-0 flex-1">
                  ...
                  <div class="mt-4 grid grid-cols-2 gap-3">
                      <div>
                          <p class="text-[13px] font-bold text-[#46516B]">🔥 トレーニング日数</p>
                      ...
                      <div>
                          <p class="text-[13px] font-bold text-[#46516B]">🪙 獲得ポイント</p>
                          <p class="mt-1 text-[28px] font-black leading-none text-[#071433]">
                              {{ number_format($myMonthlyPoints) }}<span class="text-[15px]">pt</span>
                          </p>
                      </div>
