          ...
          <main>
              ...
              <section class="mb-6">
                  <div class="mb-4 flex items-center justify-between">
                      ...
                      <a href="{{ route('trainings.index') }}" class="flex items-center gap-1 text-[15px] font-black text-[#0D4FE8]">
                          すべてのトレーニングを見る
              ...
              <section class="grid grid-cols-[320px_1fr] gap-5">
                  ...
                  <div class="rounded-[16px] border border-[#DDE6F5] bg-white px-5 py-5 shadow-[0_8px_22px_rgba(15,43,95,0.06)]">
                      <div class="mb-4 flex items-center justify-between">
                          ...
                          <a href="#pcTrainingHistory" class="text-[15px] font-black text-[#0D4FE8]">
                              すべて見る
                          </a>
                      </div>
              ...
              <section class="rounded-[18px] border border-[#DDE6F5] bg-white px-6 py-6 shadow-[0_8px_22px_rgba(15,43,95,0.06)]">
                  ...
                  <div class="space-y-6">
                      <div class="flex gap-4">
                          <span class="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-emerald-500 text-[14px] text-white">
                              ✓
                          </span>
                          <div>
