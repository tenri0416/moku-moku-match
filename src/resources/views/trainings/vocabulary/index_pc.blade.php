                      ...
                      <tr class="border-t border-[#E8EDF6]">
                          <td class="px-5 py-4 align-top">
                              ...
                              <p class="mt-1 text-xs font-bold text-[#64748B]">
                                  重要度{{ $word->importance }} ・ 復習{{ $word->review_count }}回 ・ 正答率{{ $word->correctRate() }}%
                              </p>
                          </td>
                          ...
                          <td class="px-5 py-4 align-top">
                              ...
                              <p class="mt-2 line-clamp-1 rounded-xl bg-[#F8FAFF] px-3 py-2 text-xs font-bold text-[#64748B]">
                          ...
                          <td class="px-5 py-4 align-top">
                              <div class="flex justify-end gap-2">
                                  ...
                                  <form method="POST" action="{{ route('trainings.vocabulary.destroy', $word) }}">
                                      @csrf
                                      @method('DELETE')
                                      <button class="rounded-xl border border-red-200 bg-red-50 px-4 py-2 text-sm font-black text-red-600">
                                          削除
                                      </button>
                                  </form>
                              </div>
