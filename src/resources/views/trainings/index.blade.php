...
<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="grid md:grid-cols-3 gap-4 mb-8">
        <a href="{{ route('trainings.diary.create') }}" data-ai-loading-link="true" data-ai-loading-type="question"
        ...
        <a href="{{ route('trainings.challenge.create') }}" data-ai-loading-link="true" data-ai-loading-type="question"
        ...
        <a href="{{ route('trainings.verbalization.create') }}" data-ai-loading-link="true"
        ...
        <a href="{{ route('trainings.abstraction.create') }}" data-ai-loading-link="true"
            data-ai-loading-type="question"
        ...
        <a href="{{ route('trainings.concretization.create') }}" data-ai-loading-link="true"
            data-ai-loading-type="question"
