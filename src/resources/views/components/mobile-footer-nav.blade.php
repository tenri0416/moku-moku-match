...
<nav class="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white/95 backdrop-blur md:hidden">
    <div class="grid grid-cols-3">
        {{-- 募集を検索 --}}
        <a
            href="{{ route('home') }}"
            class="flex flex-col items-center justify-center gap-1 px-2 py-3 transition
        ...
        >
            ...
            <span class="text-xs font-bold leading-tight">募集を検索</span>
        </a>
        ...
        >
            ...
            <span class="text-xs font-bold leading-tight">トレーニングする</span>
        </a>
        ...
        >
            ...
            <span class="text-xs font-bold leading-tight">記事</span>
        </a>
    </div>
</nav>
