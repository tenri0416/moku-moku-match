    ...
    <div class="absolute right-0 mt-3 w-72 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
        ...
        <div class="p-2">
            ...
            <a href="{{ route('mypage') }}"
                ...
                <span
                    class="flex h-10 w-10 items-center justify-center rounded-full bg-indigo-600 text-sm font-black text-white">
            ...
            <button type="button" data-open-notification-modal
