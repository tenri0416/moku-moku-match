{{-- SP版：resources/views/messages/show_sp.blade.php --}}
  ...
  <div class="mx-auto flex min-h-screen w-full max-w-[430px] flex-col overflow-x-hidden bg-[#F8FAFF] px-4 pb-5 pt-4">
      ...
      <header class="mb-4">
          ...
          <div class="rounded-[18px] border border-[#DDE6F5] bg-white px-4 py-4 shadow-[0_8px_22px_rgba(15,43,95,0.06)]">
              ...
              <div class="mt-4 rounded-[14px] bg-[#F4F8FF] px-4 py-3">
                  <p class="text-[13px] font-bold text-[#64748B]">募集</p>
                  <p class="mt-1 line-clamp-2 text-[15px] font-black leading-relaxed text-[#071433]">
                      {{ $workPostTitle }}
                  </p>
              </div>
          </div>
      ...
      <section class="min-h-0 flex-1 overflow-hidden rounded-[18px] border border-[#DDE6F5] bg-white shadow-[0_8px_22px_rgba(15,43,95,0.06)]">
          <div class="h-[calc(100vh-360px)] min-h-[360px] space-y-5 overflow-y-auto px-4 py-5" data-message-list>
