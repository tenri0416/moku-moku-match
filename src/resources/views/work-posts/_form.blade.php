...
<div class="space-y-6">
    ...
    <div>
        ...
        <textarea id="body" name="body" rows="8" placeholder="募集内容を入力してください。例：Zoomをつないで、最初と最後だけ会話し、作業中は黙々作業したいです。"
    ...
    <div class="grid gap-6 md:grid-cols-2">
        ...
        <div>
            ...
            <input type="text" id="purpose" name="purpose" value="{{ old('purpose', $workPost->purpose ?? '') }}"
        ...
        <div>
            ...
            <select id="prefecture_id" name="prefecture_id"
                ...
                <option value="{{ $prefecture->id }}" @selected((string) old('prefecture_id', $workPost->prefecture_id
        ...
        <div>
            ...
            <input type="number" id="max_participants" name="max_participants"
                value="{{ old('max_participants', $workPost->max_participants ?? '') }}" min="1" placeholder="例：2"
                class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
