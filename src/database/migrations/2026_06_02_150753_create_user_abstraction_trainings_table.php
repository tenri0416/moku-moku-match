...
return new class extends Migration
{
    ...
    {
        Schema::create('user_abstraction_trainings', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedTinyInteger('readability_score')->nullable()->comment('共通点の発見');
            $table->unsignedTinyInteger('specificity_score')->nullable()->comment('本質の捉え方');
            $table->unsignedTinyInteger('structure_score')->nullable()->comment('理由の説明');
            $table->unsignedTinyInteger('expression_score')->nullable()->comment('言葉の簡潔さ');
            ...
            $table->unique(['user_id', 'training_date'], 'user_abstraction_daily_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('user_abstraction_trainings');
    }
};
